...
export const router = createBrowserRouter([
  {
    ...
    children: [
      { path: "/", element: <Home /> },
      { path: "/winter", lazy: async () => ({ Component: (await import("@/pages/WinterDashboard")).WinterDashboard }) },
      { path: "/research-library", lazy: async () => ({ Component: (await import("@/pages/ResearchLibrary")).ResearchLibrary }) },
      { path: "/daily-review", lazy: async () => ({ Component: (await import("@/pages/DailyReview")).DailyReview }) },
      { path: "/sentiment", lazy: async () => ({ Component: (await import("@/pages/SentimentDashboard")).SentimentDashboard }) },
      { path: "/astock", lazy: async () => ({ Component: (await import("@/pages/AstockWorkbench")).AstockWorkbench }) },
      ...
      { path: "/industry-news", element: <Navigate replace to="/intel/investment-news" /> },
