...
import {
  Activity, Cable, CandlestickChart, ChevronDown, ChevronsLeft, ChevronsRight, Cog, Cpu, Database, FileText, FlaskConical, Gauge, Github, Globe, Home, Layers3, LayoutGrid, Microscope, Menu, X, Moon, Newspaper, NotebookPen, Radar, Rocket, Rss, Settings, Snowflake, Star, Sun, Swords, Thermometer, TrendingUp, UserRound, Wallet,
} from "lucide-react";
